        ...
        <section className="py-10">
          ...
          <div className="mx-4">
            ...
            <ul className="mx-4 my-2 list-disc list-inside">
              ...
              <li>
                le directeur de la publication du site web est Valérian CASTEL,
                en qualité de représentant légal de Tomorrow Security ;
              </li>
              <li>
            ...
            <p className="text-justify">
              ...
              uniquement dans le cadre légal prévu en France pour le respect de
              la vie privée. La société Tomorrow Security est le destinataire
              des données. Conformément à la loi « informatique et libertés » du
              6 janvier 1978, vous bénéficiez d&apos;un droit d&apos;accès, de
              rectification, de suppression des informations qui vous
            ...
            <p>
              ...
              informations postées sur le site et/ou à propos des commentaires
              que ces informations peuvent susciter.
            </p>
            <p>
              Par conséquent, la société Tomorrow Security exclut toute
              responsabilité pour n&apos;importe quel préjudice causé
              directement et/ou indirectement, de quelque façon que ce soit, du
              fait de l&apos;utilisation du site. Notamment, Tomorrow Security
              ne sera en aucun cas responsable d&apos;un quelconque préjudice,
              causé par :
            </p>
            <ul className="mx-4 my-2 list-disc list-inside">
