			...
			<main>
				<div className="py-10 mx-4 md:container md:mx-auto md:py-20">
					...
					<p className="text-justify">
						La présente politique de confidentialité définit et vous informe de
						la manière dont Tomorrow Security (sous la marque Tera Campus)
						utilise et protège les informations que vous nous transmettez.
					</p>
					<br />
					<p className="text-justify">
						Vous pouvez choisir d&apos;accéder et de naviguer sur nos sites
						Internet sans communiquer vos données personnelles. Lorsque Tomorrow
						Security collecte vos données personnelles, cette collecte est
						effectuée de manière loyale et transparente grâce à la mention
						d&apos;informations ou de renvoi à la présente politique de
						confidentialité.
					</p>
					<br />
					<p className="text-justify">
						...
						l&apos;adresse postale, le lieu de résidence, le numéro de téléphone
						ou l&apos;adresse email. Elles sont collectées via les différents
						formulaires présents sur nos sites (
						<a href="https://tera-campus.com">www.tera-campus.com</a>) pour une
						demande d&apos;information commerciale ou pour déposer un dossier de
						pré-inscription aux formations Tera Campus. Le caractère obligatoire
						des réponses est indiqué dans les formulaires. Si vous ne souhaitez
						pas fournir de tels renseignements, vous ne pourrez éventuellement
						pas accéder à certains services ou fonctionnalités de nos sites.
					</p>
					<br />
					<p className="text-justify">
						Conformément au Règlement Général sur la Protection des Données
						(General Data Protection Régulation) adopté par le Parlement
						Européen le 14 avril 2016, et à la Loi Informatique et Libertés du 6
						janvier 1978 modifiée, Tomorrow Security vous informe des points
						suivants :
					</p>
					<ul className="mx-4 my-2">
						...
						<li>
							<span className="font-bold">2. Finalités du traitement</span>
							<p>
						...
						<li>
							<span className="font-bold">3. Durée de conservation</span>
							<p>
						...
						<li>
							<span className="font-bold">
								5. Prestataires utilisés dans le cadre de la collecte de vos
								données
							</span>
							<p>
						...
						<li>
							<span className="font-bold">6. Cookies</span>
							<p>Tera Campus n&apos;utilise pas de cookies.</p>
						</li>
					</ul>
				</div>
			</main>
