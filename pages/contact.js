              ...
              <div className="flex flex-col w-full px-2 space-y-2 md:w-1/2">
                ...
                <div className="flex flex-col items-start justify-start">
                  <div className="flex flex-row items-start justify-start flex-nowrap">
                    <div className="w-4 h-4 m-2 transform rotate-45 bg-tc-red"> </div>
                    <div className="flex flex-col w-11/12">
                      <p className="pt-1 pl-2">Ou bien, tu peux poser directement tes questions via le formulaire ci-dessous :</p>
                      <div className="m-0.5 animate-bounce">
                        <div className="w-8 h-8 mx-auto transform -rotate-60">
                          <IconCurvedArrowX />
                        </div>
                      </div>
                      <form className="grid grid-cols-1 gap-4 pr-2 place-content-center md:pr-0" onSubmit={handleSubmit(onSubmit)}>
                        <label className="block">
                          ...
                          />
                          {
                            errors.email && <span className="text-tc-red">Nous avons besoin de ton adresse e-mail afin de pouvoir te répondre.</span>
                          }
                        ...
                        <label className="block">
                          ...
                          />
                          {
                            errors.message && <span className="text-tc-red">As-tu oublié ce que tu souhaites nous dire ?</span>
                          }
                        </label>
                        ...
                        <InputCheckRGPD /> */}
                          ...
                          {
                            errors.acceptPrivacyRules && <span className="text-tc-red">Tu dois accepter la politique de confidentialité pour continuer.</span>
                          }
                        </div>
                        <div className="flex justify-center">
                ...
                <div className="flex flex-row items-start flex-nowrap">
                  <div className="w-4 h-4 m-2 transform rotate-45 bg-tc-red"> </div>
                  <div className="flex flex-col w-11/12 ">
                    <p className="pt-1 pl-2 pr-4 md:pr-0">Et tu peux aussi joindre Tera Campus à ce numéro :</p>
                    <div className="flex justify-center">
                      <p className="py-2 mx-auto mb-2 text-sm text-center w-max md:text-lg hover:text-tc-red">&#9742;04.69.96.00.65</p>
                    </div>
                  </div>
                </div>
              </div>
