					...
					<div className="space-y-1 xl:space-y-8 xl:flex xl:flex-col xl:items-center ">
						<div className="xl:flex xl:justify-between xl:w-4/5 xl:flex-nowrap">
							...
							<div className="space-y-1 xl:w-45%">
								...
								{errors.email ? (
									<div className="text-center text-tc-red">
										Vous devez donner votre email pour continuer votre
										inscription
									</div>
								) : null}
							</div>
						...
						<div className="xl:flex xl:justify-between xl:w-4/5 xl:flex-nowrap">
							...
							<div className="space-y-1 xl:w-45%">
								...
								{errors.firstName ? (
									<div className="text-center text-tc-red">
										Vous devez donner votre prénom pour continuer votre
										inscription
									</div>
								) : null}
							</div>
						...
						<div className="xl:flex xl:justify-between xl:w-4/5 xl:flex-nowrap">
							<div className="space-y-1 xl:w-45%">
								<div className="space-y-1">
									...
									{errors.phone ? (
										<div className="text-center text-tc-red">
											Vou devez donner votre numéro de téléphone pour continuer
											votre inscription
										</div>
									) : null}
								</div>
