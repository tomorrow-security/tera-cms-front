export default function SocialLink({ name, url, logo }) {
  return (
    <a
      ...
      aria-label={name}
    >
      <div className="flex items-center justify-center w-12 h-12 transition-all duration-200 ease-out transform scale-100 rounded-full group-hover:scale-0 group-hover:ease-in bg-tc-blue group-hover:bg-tc-blue"></div>
