...
export default function ExternalLink({ title, url }) {
    ...
    <div className="flex justify-center pt-8 my-2">
        ...
        */}
        <a href={url} className="relative z-10 w-full overflow-hidden rounded-t h-7 md:h-9 md:w-4/5 group md:text-xl bg-tc-blue rounded-b-xl visited:text-tc-red-light">
