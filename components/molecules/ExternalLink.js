	...
	return (
        ...
        */}
			<a
				...
				rel="noreferrer"
				aria-label={aria}
				className="relative z-10 w-11/12 h-8 pt-1 overflow-hidden text-sm rounded-t md:h-9 md:w-4/5 group md:text-xl bg-tc-blue rounded-b-xl visited:text-tc-red visited:text-opacity-50"
			>
