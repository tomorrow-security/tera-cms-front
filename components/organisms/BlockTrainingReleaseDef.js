export default function BlockReleaseTrainingDef() {
  return (
    <section id="BlockReleaseTrainingDef" className="py-5 lg:py-10">
      <div className="mx-4 md:container md:mx-auto">
        <h2 className="text-lg font-bold md:mx-6 lg:mx-12 lg:text-xl 2xl:text-2xl">
          L'alternance chez c'est quoi ?
        </h2>
