		...
		<div className="px-4 border-t border-tc-red md:pt-4 md:w-1/5">
			...
			>
				<div
					...
					} flex flex-nowrap justify-around items-center md:flex-col-reverse md:text-center bg-white bg-opacity-80 w-full h-full z-10`}
				>
	...
	const displayPricing = () => {
		...
		return (
			<>
				<div className="flex flex-row items-center my-2">
					<div className="w-5 h-5 mr-4 transform rotate-45 bg-tc-red"> </div>
					<h2 className="w-5/6 text-lg font-bold text-tc-blue sm:text-xl xl:text-2xl">
