            ...
            <>
                ...
                <div className="flex justify-center pt-8 my-2">
                    ...
                    <a
                        ...
                        className="relative z-10 p-2 overflow-hidden font-semibold text-center text-white transition duration-700 rounded-t group md:text-xl bg-tc-blue rounded-b-xl">
                            <span className="absolute left-0 z-20 h-full transition-all ease-in delay-100 transform rounded-full bg-tc-red w-1/8 -bottom-full group-hover:-translate-y-full group-hover:scale-150"></span>
                            <span className="absolute z-20 h-full transition-all ease-in delay-200 transform rounded-full w-1/8 -bottom-full left-1/8 group-hover:-translate-y-full bg-tc-red group-hover:scale-150"></span>
                            ...
                            <p className="z-30">Comment trouver une entreprise ?</p>
                    </a>
                </div>
            </>
        )
