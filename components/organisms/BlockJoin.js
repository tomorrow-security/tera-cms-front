        ...
        return (
            <>
                ...
                <div className="flex justify-center pt-8 my-2">
                     {/* // TODO ajouter visited */}
                    <a href="https://www.alternance.emploi.gouv.fr/portail_alternance/" className="relative z-10 w-full overflow-hidden transition duration-700 rounded-t h-7 md:h-9 md:w-4/5 group md:text-xl bg-tc-blue rounded-b-xl">
                        ...
                        <p className="absolute z-30 inline-block w-full h-full font-semibold text-center text-white align-bottom">Comment trouver une entreprise ? &#x1F517;
                        </p>
                    </a>
                </div>
            </>
