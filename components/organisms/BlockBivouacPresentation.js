        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:pl-4">
            ...
            <List>
              ...
              <li>
                Acquérir des compétences managériales et comportementales.
              </li>
            </List>
            <Paragraphe>
              Les lieux de rendez-vous des séminaires sont définit par Tera
              Campus à l'avance, et ils sont entièrement financés par l'école.
            </Paragraphe>
