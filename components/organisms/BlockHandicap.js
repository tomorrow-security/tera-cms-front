    ...
    <section id="handicap" className="py-5">
      <div className="md:container md:mx-auto">
        <div className="mx-4">
          ...
          <List>
            <li>
              Vous accompagner dans toutes vos démarches, qu’elles soient
              internes ou externes (Agefipph, MDPH…)
            </li>
          ...
          <LittleTitle>
            Comment se passe l’admission pour le public en situation de
            hadicap ?
          </LittleTitle>
          <List>
            <li>
            ...
            <li>
              A l’issue de cet entretien, vous aurez tous les éléments
              nécessaires à votre éventuelle admission au sein de notre école
            </li>
          </List>
          <Paragraphe>
