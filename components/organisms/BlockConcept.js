    ...
    <section id="concept" className="pt-4 md:py-10 lg:py-20">
        ...
        <div className="relative flex flex-col justify-center max-w-full mx-auto mb-8 text-xl font-bold text-center sm:text-2xl border-box w-max">
				...
				<div className="flex flex-col lg:flex-row">
					<ul className="mx-2 md:mx-0 md:pl-2 lg:w-2/3">
						<li>
							...
							<Paragraph gutterBottom>
								<Strong>Tera Campus est une école Supérieure d'Informatique en télé-présentiel,&nbsp;</Strong>
									et propose des formations diplômantes&nbsp;
									<em className="not-italic font-bold ">(en initial et en alternance)&nbsp;</em>
						...
						<li>
							...
							<Paragraph gutterBottom>
								<Strong>La formation Tera Campus peut être suivie de n'importe où avec un seul pré-requis : un ordinateur et une connexion internet.&nbsp;</Strong>
						...
						<li>
							...
							<Paragraph gutterBottom>
								...
								<Strong>
									En octobre, en février puis en mai, tu rejoindras les autres étudiants de Tera Campus pour partager, créer et construire un esprit d'équipe au travers d'exercices de team building et de Hackathons.&nbsp;
								</Strong>
					...
					<div className="w-full h-64 bg-center bg-cover lg:w-1/2 lg:h-auto lg:hy-auto lg:mx-2" style={{ backgroundImage: "url('students-collaboration.jpg')" }}></div>
				</div>
